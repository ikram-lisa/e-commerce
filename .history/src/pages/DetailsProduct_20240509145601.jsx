    ...
    <>
      <section className="product-content pr-20">
        <div className="content">
          ...
          <section className="product-price mb-7">
            <div className="price">
            ...
            <p className="new-price text-sm text-gray-300 mt-1 line-through font-bold">
              <span>$249.00 </span>
            </p>
          </section>
          ...
          <section className="purchase-info  flex items-center gap-10">
            <div className="add-info ">
              <form className="max-w-xs mx-auto">
                <div className="info-quantity relative flex items-center max-w-[8rem]">
                  <button
                    type="button"
                    id="decrement-button"
