...
const Header = () => {
  ...
  return (
    <>
      <div className="responsive-design S:hidden md:hidden">
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-30 z-50">
            <div className="fixed top-0 left-0 w-[18%]  h-full bg-white p-6 z-50 flex flex-col gap-10">
      ...
      <header className="header  w-full px-[6rem] py-3 xs:hidden S:block justify-between">
