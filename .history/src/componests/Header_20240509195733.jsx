  ...
  return (
    <>
      <div className="menu-responsive">
        ...
        <div className="nav-responsive   w-[20%] h-[100vh] bg-red-900 absolute z-[999999] px-4 py-6">
          <button
      ...
      <header className="header flex justify-between w-full px-[6rem] py-3 hidden">
